...
/**
 * $Id: index.php,v 1.21 2005/08/15 16:51:57 fx2024 Exp $
 * Module: SmartFAQ
...
function buildTable()
{
    ...
    echo "<td width='40' class='bg3' align='center'><b>" . _AM_SF_FAQID . '</b></td>';

    echo "<td width='20%' class='bg3' align='center'><b>" . _AM_SF_FAQCAT . '</b></td>';

    echo "<td class='bg3' align='center'><b>" . _AM_SF_QUESTION . '</b></td>';

    echo "<td width='90' class='bg3' align='center'><b>" . _AM_SF_CREATED . '</b></td>';

    echo "<td width='90' class='bg3' align='center'><b>" . _AM_SF_STATUS . '</b></td>';

    //echo "<td width='30' class='bg3' align='center'><b>" . _AM_SF_ANSWERS . "</b></td>";

    echo "<td width='90' class='bg3' align='center'><b>" . _AM_SF_ACTION . '</b></td>';
...
// Total asked FAQs
$totalasked = $totalfaqbystatus[_SF_STATUS_ASKED] ?? 0;

// Total opened FAQs
$totalopened = $totalfaqbystatus[_SF_STATUS_OPENED] ?? 0;

// Total answered FAQs
$totalanswered = $totalfaqbystatus[_SF_STATUS_ANSWERED] ?? 0;

// Total submitted FAQs
$totalsubmitted = $totalfaqbystatus[_SF_STATUS_SUBMITTED] ?? 0;

// Total published FAQs
$totalpublished = $totalfaqbystatus[_SF_STATUS_PUBLISHED] ?? 0;

// Total offline FAQs
$totaloffline = $totalfaqbystatus[_SF_STATUS_OFFLINE] ?? 0;

// Total rejected question
$totalrejectedquestion = $totalfaqbystatus[_SF_STATUS_REJECTED_QUESTION] ?? 0;

// Total rejected smartfaq
$totalrejectedsmartfaq = $totalfaqbystatus[_SF_STATUS_REJECTED_SMARTFAQ] ?? 0;

// Total Q&A with new answers
$totalnewanswers = $totalfaqbystatus[_SF_STATUS_NEW_ANSWER] ?? 0;
...
if ($numrows > 0) {
    ...
    foreach (array_keys($faqsObj) as $i) {
        ...
        switch ($faqsObj[$i]->status()) {
            ...
            $approve = "<a href='question.php?op=mod&amp;faqid=" . $faqsObj[$i]->faqid() . "'><img src='" . XOOPS_URL . '/modules/' . $xoopsModule->dirname() . "/images/icon/approve.gif' title='" . _AM_SF_QUESTION_MODERATE . "'  alt='" . _AM_SF_QUESTION_MODERATE . "'></a>&nbsp;";
            $modify = '';
